...
linkml_meta = LinkMLMeta({'default_prefix': 'pg',
     ...
     'id': 'https://permitgraph.dev/spec/model/core',
     ...
     'prefixes': {'ceterms': {'prefix_prefix': 'ceterms',
                  ...
                  'pg': {'prefix_prefix': 'pg',
                         'prefix_reference': 'https://permitgraph.dev/spec/model/core/'},
...
class BusinessEntity(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://permitgraph.dev/spec/model/core'})
...
class Correspondence(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'exact_mappings': ['xkos:Correspondence'],
         'from_schema': 'https://permitgraph.dev/spec/model/core'})
